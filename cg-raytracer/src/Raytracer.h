...
{
public:
    explicit Raytracer(const std::string& filename);
    ~Raytracer();
...
private:
    /// Finds the closest collision point for the passed Ray and returns the computed color for this object.
    /**
    ...
    */
    [[nodiscard]] vec3 lighting(const vec3& point, const vec3& normal, const vec3& view,
