...
public:
    ...
    explicit Mesh(Draw_mode draw_mode = FLAT, const std::string& filename = 0);
    ...
    bool intersect(const Ray& ray, vec3& intersection_point,
                   vec3& intersection_normal,
                   vec3& intersection_diffuse,
                   double& intersection_distance) const override;
